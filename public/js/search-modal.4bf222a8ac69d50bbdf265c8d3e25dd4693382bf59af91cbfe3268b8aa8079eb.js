(() => {
  ...
  function arrow(_ref) {
    var _state{{< math >}}$ modifiersData ${{</ math>}};
    ...
    var axisProp = axis;
    state.modifiersData[name] = (_state{{< math >}}$ modifiersData$ = {}, _state$modifiersData$[axisProp] = offset2, _state$modifiersData$.centerOffset = offset2 - center, _state$modifiersData ${{</ math>}});
  }
  function effect2(_ref2) {
    var state = _ref2.state, options = _ref2.options;
    var _options{{< math >}}$ element = options.element, arrowElement = _options$element === void 0 ? "[data-popper-arrow]" : _options ${{</ math>}}element;
  ...
  function mapToStyles(_ref2) {
    ...
    var _offsets{{< math >}}$ x = offsets.x, x = _offsets$x === void 0 ? 0 : _offsets$x, _offsets$y = offsets.y, y = _offsets$y === void 0 ? 0 : _offsets ${{</ math>}}y;
    ...
    if (gpuAcceleration) {
      var _Object$assign;
      return Object.assign({}, commonStyles, (_Object{{< math >}}$ assign = {}, _Object$assign[sideY] = hasY ? "0" : "", _Object$assign[sideX] = hasX ? "0" : "", _Object$assign.transform = (win.devicePixelRatio || 1) <= 1 ? "translate(" + x + "px, " + y + "px)" : "translate3d(" + x + "px, " + y + "px, 0)", _Object ${{</ math>}}assign));
    }
    return Object.assign({}, commonStyles, (_Object{{< math >}}$ assign2 = {}, _Object$assign2[sideY] = hasY ? y + "px" : "", _Object$assign2[sideX] = hasX ? x + "px" : "", _Object$assign2.transform = "", _Object ${{</ math>}}assign2));
  }
  function computeStyles(_ref5) {
    var state = _ref5.state, options = _ref5.options;
    var _options{{< math >}}$ gpuAccelerat = options.gpuAcceleration, gpuAcceleration = _options$gpuAccelerat === void 0 ? true : _options$gpuAccelerat, _options$adaptive = options.adaptive, adaptive = _options$adaptive === void 0 ? true : _options$adaptive, _options$roundOffsets = options.roundOffsets, roundOffsets = _options$roundOffsets === void 0 ? true : _options ${{</ math>}}roundOffsets;
    var commonStyles = {
  ...
  function effect3(_ref) {
    ...
    var _options{{< math >}}$ scroll = options.scroll, scroll = _options$scroll === void 0 ? true : _options$scroll, _options$resize = options.resize, resize = _options$resize === void 0 ? true : _options ${{</ math>}}resize;
  ...
  function getDocumentRect(element) {
    ...
    var body = (_element{{< math >}}$ ownerDocumen = element.ownerDocument) == null ? void 0 : _element ${{</ math>}}ownerDocumen.body;
  ...
  function listScrollParents(element, list) {
    ...
    var isBody = scrollParent === ((_element{{< math >}}$ ownerDocumen = element.ownerDocument) == null ? void 0 : _element ${{</ math>}}ownerDocumen.body);
  ...
  function detectOverflow(state, options) {
    ...
    var _options = options, _options{{< math >}}$ placement = _options.placement, placement = _options$placement === void 0 ? state.placement : _options$placement, _options$strategy = _options.strategy, strategy = _options$strategy === void 0 ? state.strategy : _options$strategy, _options$boundary = _options.boundary, boundary = _options$boundary === void 0 ? clippingParents : _options$boundary, _options$rootBoundary = _options.rootBoundary, rootBoundary = _options$rootBoundary === void 0 ? viewport : _options$rootBoundary, _options$elementConte = _options.elementContext, elementContext = _options$elementConte === void 0 ? popper : _options$elementConte, _options$altBoundary = _options.altBoundary, altBoundary = _options$altBoundary === void 0 ? false : _options$altBoundary, _options$padding = _options.padding, padding = _options$padding === void 0 ? 0 : _options ${{</ math>}}padding;
  ...
  function computeAutoPlacement(state, options) {
    ...
    var _options = options, placement = _options.placement, boundary = _options.boundary, rootBoundary = _options.rootBoundary, padding = _options.padding, flipVariations = _options.flipVariations, _options{{< math >}}$ allowedAutoP = _options.allowedAutoPlacements, allowedAutoPlacements = _options$allowedAutoP === void 0 ? placements : _options ${{</ math>}}allowedAutoP;
  ...
  function flip(_ref) {
    ...
    var _options{{< math >}}$ mainAxis = options.mainAxis, checkMainAxis = _options$mainAxis === void 0 ? true : _options$mainAxis, _options$altAxis = options.altAxis, checkAltAxis = _options$altAxis === void 0 ? true : _options$altAxis, specifiedFallbackPlacements = options.fallbackPlacements, padding = options.padding, boundary = options.boundary, rootBoundary = options.rootBoundary, altBoundary = options.altBoundary, _options$flipVariatio = options.flipVariations, flipVariations = _options$flipVariatio === void 0 ? true : _options ${{</ math>}}flipVariatio, allowedAutoPlacements = options.allowedAutoPlacements;
  ...
  function offset(_ref2) {
    ...
    var _options{{< math >}}$ offset = options.offset, offset2 = _options$offset === void 0 ? [0, 0] : _options ${{</ math>}}offset;
    var data = placements.reduce(function(acc, placement) {
      acc[placement] = distanceAndSkiddingToXY(placement, state.rects, offset2);
      return acc;
    }, {});
    var _data{{< math >}}$ state$placement = data[state.placement], x = _data$state$placement.x, y = _data$state ${{</ math>}}placement.y;
    if (state.modifiersData.popperOffsets != null) {
  ...
  function preventOverflow(_ref) {
    var state = _ref.state, options = _ref.options, name = _ref.name;
    var _options{{< math >}}$ mainAxis = options.mainAxis, checkMainAxis = _options$mainAxis === void 0 ? true : _options$mainAxis, _options$altAxis = options.altAxis, checkAltAxis = _options$altAxis === void 0 ? false : _options$altAxis, boundary = options.boundary, rootBoundary = options.rootBoundary, altBoundary = options.altBoundary, padding = options.padding, _options$tether = options.tether, tether = _options$tether === void 0 ? true : _options$tether, _options$tetherOffset = options.tetherOffset, tetherOffset = _options$tetherOffset === void 0 ? 0 : _options ${{</ math>}}tetherOffset;
    var overflow = detectOverflow(state, {
      boundary,
      rootBoundary,
      padding,
    ...
    if (checkMainAxis) {
      ...
      var offsetModifierValue = (_offsetModifierState{{< math >}}$  = offsetModifierState == null ? void 0 : offsetModifierState[mainAxis]) != null ? _offsetModifierState ${{</ math>}} : 0;
    ...
    if (checkAltAxis) {
      ...
      var _offsetModifierValue = (_offsetModifierState{{< math >}}$ 2 = offsetModifierState == null ? void 0 : offsetModifierState[altAxis]) != null ? _offsetModifierState ${{</ math>}}2 : 0;
  ...
  function popperGenerator(generatorOptions) {
    ...
    var _generatorOptions = generatorOptions, _generatorOptions{{< math >}}$ def = _generatorOptions.defaultModifiers, defaultModifiers3 = _generatorOptions$def === void 0 ? [] : _generatorOptions$def, _generatorOptions$def2 = _generatorOptions.defaultOptions, defaultOptions = _generatorOptions$def2 === void 0 ? DEFAULT_OPTIONS : _generatorOptions ${{</ math>}}def2;
    return function createPopper4(reference2, popper2, options) {
      ...
      var instance = {
        ...
        forceUpdate: function forceUpdate() {
          ...
          var _state{{< math >}}$ elements = state.elements, reference3 = _state$elements.reference, popper3 = _state ${{</ math>}}elements.popper;
          ...
          for (var index = 0; index < state.orderedModifiers.length; index++) {
            ...
            var _state{{< math >}}$ orderedModifie = state.orderedModifiers[index], fn2 = _state$orderedModifie.fn, _state$orderedModifie2 = _state$orderedModifie.options, _options = _state$orderedModifie2 === void 0 ? {} : _state$orderedModifie2, name = _state ${{</ math>}}orderedModifie.name;
      ...
      function runModifierEffects() {
        state.orderedModifiers.forEach(function(_ref) {
          var name = _ref.name, _ref{{< math >}}$ options = _ref.options, options2 = _ref$options === void 0 ? {} : _ref ${{</ math>}}options, effect4 = _ref.effect;
  ...
  function makeEventUid(element, uid) {
    return uid && `{{< math >}}$ {uid}:: ${{</ math>}}{uidEvent++}` || element.uidEvent || uidEvent++;
  }
    ...
    _typeCheckConfig(config, configTypes = this.constructor.DefaultType) {
      for (const [property, expectedTypes] of Object.entries(configTypes)) {
        ...
        if (!new RegExp(expectedTypes).test(valueType)) {
          throw new TypeError(`{{< math >}}$ {this.constructor.NAME.toUpperCase()}: Option "${property}" provided type "${valueType}" but expected type " ${{</ math>}}{expectedTypes}".`);
        }
      }
    }
  };
  ...
  var BaseComponent = class extends Config {
    ...
    static eventName(name) {
      return `{{< math >}}$ {name} ${{</ math>}}{this.EVENT_KEY}`;
    }
  };
  ...
  var EVENT_KEY{{< math >}}$ b = `.${DATA_KEY ${{</ math>}}a}`;
  var EVENT_CLOSE = `close{{< math >}}$ {EVENT_KEY ${{</ math>}}b}`;
  var EVENT_CLOSED = `closed{{< math >}}$ {EVENT_KEY ${{</ math>}}b}`;
  ...
  var EVENT_KEY{{< math >}}$ a = `.${DATA_KEY ${{</ math>}}9}`;
  var DATA_API_KEY$6 = ".data-api";
  var CLASS_NAME_ACTIVE$3 = "active";
  var SELECTOR_DATA_TOGGLE$5 = '[data-bs-toggle="button"]';
  var EVENT_CLICK_DATA_API{{< math >}}$ 6 = `click${EVENT_KEY$a}${DATA_API_KEY ${{</ math>}}6}`;
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API{{< math >}}$ 6, SELECTOR_DATA_TOGGLE ${{</ math>}}5, (event) => {
    event.preventDefault();
  ...
  var EVENT_TOUCHSTART = `touchstart{{< math >}}$ {EVENT_KEY ${{</ math>}}9}`;
  var EVENT_TOUCHMOVE = `touchmove{{< math >}}$ {EVENT_KEY ${{</ math>}}9}`;
  var EVENT_TOUCHEND = `touchend{{< math >}}$ {EVENT_KEY ${{</ math>}}9}`;
  var EVENT_POINTERDOWN = `pointerdown{{< math >}}$ {EVENT_KEY ${{</ math>}}9}`;
  var EVENT_POINTERUP = `pointerup{{< math >}}$ {EVENT_KEY ${{</ math>}}9}`;
  ...
  var EVENT_KEY{{< math >}}$ 8 = `.${DATA_KEY ${{</ math>}}8}`;
  ...
  var EVENT_SLIDE = `slide{{< math >}}$ {EVENT_KEY ${{</ math>}}8}`;
  var EVENT_SLID = `slid{{< math >}}$ {EVENT_KEY ${{</ math>}}8}`;
  var EVENT_KEYDOWN{{< math >}}$ 1 = `keydown${EVENT_KEY ${{</ math>}}8}`;
  var EVENT_MOUSEENTER{{< math >}}$ 1 = `mouseenter${EVENT_KEY ${{</ math>}}8}`;
  var EVENT_MOUSELEAVE{{< math >}}$ 1 = `mouseleave${EVENT_KEY ${{</ math>}}8}`;
  var EVENT_DRAG_START = `dragstart{{< math >}}$ {EVENT_KEY ${{</ math>}}8}`;
  var EVENT_LOAD_DATA_API{{< math >}}$ 3 = `load${EVENT_KEY$8}${DATA_API_KEY ${{</ math>}}5}`;
  var EVENT_CLICK_DATA_API{{< math >}}$ 5 = `click${EVENT_KEY$8}${DATA_API_KEY ${{</ math>}}5}`;
  ...
  var EVENT_KEY{{< math >}}$ 7 = `.${DATA_KEY ${{</ math>}}7}`;
  var DATA_API_KEY$4 = ".data-api";
  var EVENT_SHOW{{< math >}}$ 6 = `show${EVENT_KEY ${{</ math>}}7}`;
  var EVENT_SHOWN{{< math >}}$ 6 = `shown${EVENT_KEY ${{</ math>}}7}`;
  var EVENT_HIDE{{< math >}}$ 6 = `hide${EVENT_KEY ${{</ math>}}7}`;
  var EVENT_HIDDEN{{< math >}}$ 6 = `hidden${EVENT_KEY ${{</ math>}}7}`;
  var EVENT_CLICK_DATA_API{{< math >}}$ 4 = `click${EVENT_KEY$7}${DATA_API_KEY ${{</ math>}}4}`;
  var CLASS_NAME_SHOW$7 = "show";
  var CLASS_NAME_COLLAPSE = "collapse";
  var CLASS_NAME_COLLAPSING = "collapsing";
  var CLASS_NAME_COLLAPSED = "collapsed";
  var CLASS_NAME_DEEPER_CHILDREN = `:scope .{{< math >}}$ {CLASS_NAME_COLLAPSE} . ${{</ math>}}{CLASS_NAME_COLLAPSE}`;
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API{{< math >}}$ 4, SELECTOR_DATA_TOGGLE ${{</ math>}}4, function(event) {
  ...
  var EVENT_KEY{{< math >}}$ 6 = `.${DATA_KEY ${{</ math>}}6}`;
  ...
  var EVENT_HIDE{{< math >}}$ 5 = `hide${EVENT_KEY ${{</ math>}}6}`;
  var EVENT_HIDDEN{{< math >}}$ 5 = `hidden${EVENT_KEY ${{</ math>}}6}`;
  var EVENT_SHOW{{< math >}}$ 5 = `show${EVENT_KEY ${{</ math>}}6}`;
  var EVENT_SHOWN{{< math >}}$ 5 = `shown${EVENT_KEY ${{</ math>}}6}`;
  var EVENT_CLICK_DATA_API{{< math >}}$ 3 = `click${EVENT_KEY$6}${DATA_API_KEY ${{</ math>}}3}`;
  var EVENT_KEYDOWN_DATA_API = `keydown{{< math >}}$ {EVENT_KEY$6}${DATA_API_KEY ${{</ math>}}3}`;
  var EVENT_KEYUP_DATA_API = `keyup{{< math >}}$ {EVENT_KEY$6}${DATA_API_KEY ${{</ math>}}3}`;
  ...
  var SELECTOR_DATA_TOGGLE_SHOWN = `{{< math >}}$ {SELECTOR_DATA_TOGGLE$3}.${CLASS_NAME_SHOW ${{</ math>}}6}`;
  ...
  var Dropdown = class _Dropdown extends BaseComponent {
    ...
    _getConfig(config) {
      ...
      if (typeof config.reference === "object" && !isElement2(config.reference) && typeof config.reference.getBoundingClientRect !== "function") {
        throw new TypeError(`{{< math >}}$ {NAME ${{</ math>}}a.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
      }
      return config;
    }
    _createPopper() {
    ...
    static dataApiKeydownHandler(event) {
      ...
      const isUpOrDownEvent = [ARROW_UP_KEY{{< math >}}$ 1, ARROW_DOWN_KEY ${{</ math>}}1].includes(event.key);
      ...
      event.preventDefault();
      const getToggleButton = this.matches(SELECTOR_DATA_TOGGLE{{< math >}}$ 3) ? this : SelectorEngine.prev(this, SELECTOR_DATA_TOGGLE$3)[0] || SelectorEngine.next(this, SELECTOR_DATA_TOGGLE$3)[0] || SelectorEngine.findOne(SELECTOR_DATA_TOGGLE ${{</ math>}}3, event.delegateTarget.parentNode);
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API{{< math >}}$ 3, SELECTOR_DATA_TOGGLE ${{</ math>}}3, function(event) {
    event.preventDefault();
  ...
  var EVENT_MOUSEDOWN = `mousedown.bs.{{< math >}}$ {NAME ${{</ math>}}9}`;
  var Default$8 = {
  ...
  var EVENT_KEY{{< math >}}$ 5 = `.${DATA_KEY ${{</ math>}}5}`;
  var EVENT_FOCUSIN{{< math >}}$ 2 = `focusin${EVENT_KEY ${{</ math>}}5}`;
  var EVENT_KEYDOWN_TAB = `keydown.tab{{< math >}}$ {EVENT_KEY ${{</ math>}}5}`;
  var TAB_KEY = "Tab";
  ...
  var EVENT_KEY{{< math >}}$ 4 = `.${DATA_KEY ${{</ math>}}4}`;
  var DATA_API_KEY$2 = ".data-api";
  var ESCAPE_KEY$1 = "Escape";
  var EVENT_HIDE{{< math >}}$ 4 = `hide${EVENT_KEY ${{</ math>}}4}`;
  var EVENT_HIDE_PREVENTED{{< math >}}$ 1 = `hidePrevented${EVENT_KEY ${{</ math>}}4}`;
  var EVENT_HIDDEN{{< math >}}$ 4 = `hidden${EVENT_KEY ${{</ math>}}4}`;
  var EVENT_SHOW{{< math >}}$ 4 = `show${EVENT_KEY ${{</ math>}}4}`;
  var EVENT_SHOWN{{< math >}}$ 4 = `shown${EVENT_KEY ${{</ math>}}4}`;
  var EVENT_RESIZE{{< math >}}$ 1 = `resize${EVENT_KEY ${{</ math>}}4}`;
  var EVENT_CLICK_DISMISS = `click.dismiss{{< math >}}$ {EVENT_KEY ${{</ math>}}4}`;
  var EVENT_MOUSEDOWN_DISMISS = `mousedown.dismiss{{< math >}}$ {EVENT_KEY ${{</ math>}}4}`;
  var EVENT_KEYDOWN_DISMISS{{< math >}}$ 1 = `keydown.dismiss${EVENT_KEY ${{</ math>}}4}`;
  var EVENT_CLICK_DATA_API{{< math >}}$ 2 = `click${EVENT_KEY$4}${DATA_API_KEY ${{</ math>}}2}`;
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API{{< math >}}$ 2, SELECTOR_DATA_TOGGLE ${{</ math>}}2, function(event) {
    const target = SelectorEngine.getElementFromSelector(this);
    if (["A", "AREA"].includes(this.tagName)) {
      event.preventDefault();
    }
  ...
  var EVENT_KEY{{< math >}}$ 3 = `.${DATA_KEY ${{</ math>}}3}`;
  var DATA_API_KEY$1 = ".data-api";
  var EVENT_LOAD_DATA_API{{< math >}}$ 2 = `load${EVENT_KEY$3}${DATA_API_KEY ${{</ math>}}1}`;
  ...
  var EVENT_SHOW{{< math >}}$ 3 = `show${EVENT_KEY ${{</ math>}}3}`;
  var EVENT_SHOWN{{< math >}}$ 3 = `shown${EVENT_KEY ${{</ math>}}3}`;
  var EVENT_HIDE{{< math >}}$ 3 = `hide${EVENT_KEY ${{</ math>}}3}`;
  var EVENT_HIDE_PREVENTED = `hidePrevented{{< math >}}$ {EVENT_KEY ${{</ math>}}3}`;
  var EVENT_HIDDEN{{< math >}}$ 3 = `hidden${EVENT_KEY ${{</ math>}}3}`;
  var EVENT_RESIZE = `resize{{< math >}}$ {EVENT_KEY ${{</ math>}}3}`;
  var EVENT_CLICK_DATA_API{{< math >}}$ 1 = `click${EVENT_KEY$3}${DATA_API_KEY ${{</ math>}}1}`;
  var EVENT_KEYDOWN_DISMISS = `keydown.dismiss{{< math >}}$ {EVENT_KEY ${{</ math>}}3}`;
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API{{< math >}}$ 1, SELECTOR_DATA_TOGGLE ${{</ math>}}1, function(event) {
    const target = SelectorEngine.getElementFromSelector(this);
    if (["A", "AREA"].includes(this.tagName)) {
      event.preventDefault();
    }
  ...
  var Tooltip = class _Tooltip extends BaseComponent {
    ...
    _createTipElement(content) {
      ...
      tip.classList.remove(CLASS_NAME_FADE{{< math >}}$ 2, CLASS_NAME_SHOW ${{</ math>}}2);
  ...
  var EVENT_KEY{{< math >}}$ 2 = `.${DATA_KEY ${{</ math>}}2}`;
  var DATA_API_KEY = ".data-api";
  var EVENT_ACTIVATE = `activate{{< math >}}$ {EVENT_KEY ${{</ math>}}2}`;
  var EVENT_CLICK = `click{{< math >}}$ {EVENT_KEY ${{</ math>}}2}`;
  var EVENT_LOAD_DATA_API{{< math >}}$ 1 = `load${EVENT_KEY$2} ${{</ math>}}{DATA_API_KEY}`;
  ...
  var SELECTOR_LINK_ITEMS = `{{< math >}}$ {SELECTOR_NAV_LINKS}, ${SELECTOR_NAV_ITEMS} > ${SELECTOR_NAV_LINKS},  ${{</ math>}}{SELECTOR_LIST_ITEMS}`;
  ...
  var ScrollSpy = class _ScrollSpy extends BaseComponent {
    ...
    _activateParents(target) {
      if (target.classList.contains(CLASS_NAME_DROPDOWN_ITEM)) {
        SelectorEngine.findOne(SELECTOR_DROPDOWN_TOGGLE{{< math >}}$ 1, target.closest(SELECTOR_DROPDOWN)).classList.add(CLASS_NAME_ACTIVE ${{</ math>}}1);
        return;
      }
    ...
    _clearActiveClass(parent) {
      ...
      const activeNodes = SelectorEngine.find(`{{< math >}}$ {SELECTOR_TARGET_LINKS}.${CLASS_NAME_ACTIVE ${{</ math>}}1}`, parent);
  ...
  var EVENT_KEY{{< math >}}$ 1 = `.${DATA_KEY ${{</ math>}}1}`;
  var EVENT_HIDE{{< math >}}$ 1 = `hide${EVENT_KEY ${{</ math>}}1}`;
  var EVENT_HIDDEN{{< math >}}$ 1 = `hidden${EVENT_KEY ${{</ math>}}1}`;
  var EVENT_SHOW{{< math >}}$ 1 = `show${EVENT_KEY ${{</ math>}}1}`;
  var EVENT_SHOWN{{< math >}}$ 1 = `shown${EVENT_KEY ${{</ math>}}1}`;
  var EVENT_CLICK_DATA_API = `click{{< math >}}$ {EVENT_KEY ${{</ math>}}1}`;
  var EVENT_KEYDOWN = `keydown{{< math >}}$ {EVENT_KEY ${{</ math>}}1}`;
  var EVENT_LOAD_DATA_API = `load{{< math >}}$ {EVENT_KEY ${{</ math>}}1}`;
  ...
  var SELECTOR_INNER = `.nav-link{{< math >}}$ {NOT_SELECTOR_DROPDOWN_TOGGLE}, .list-group-item${NOT_SELECTOR_DROPDOWN_TOGGLE}, [role="tab"] ${{</ math>}}{NOT_SELECTOR_DROPDOWN_TOGGLE}`;
  var SELECTOR_DATA_TOGGLE = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]';
  var SELECTOR_INNER_ELEM = `{{< math >}}$ {SELECTOR_INNER},  ${{</ math>}}{SELECTOR_DATA_TOGGLE}`;
  var SELECTOR_DATA_TOGGLE_ACTIVE = `.{{< math >}}$ {CLASS_NAME_ACTIVE}[data-bs-toggle="tab"], .${CLASS_NAME_ACTIVE}[data-bs-toggle="pill"], . ${{</ math>}}{CLASS_NAME_ACTIVE}[data-bs-toggle="list"]`;
