...
---
# Object Localization
- Object Localization $\rightarrow$ 1 obj
- Object Detection $\rightarrow$ multiple objs
...
Params: 
- $(l_{ix},l_{iy})$: each landmark point
...
$$
- If $\text{IoU}\geq 0.5$, then the prediction box is correct. (Other threshold values are also okay, but 0.5 was conventional.)
...
Algorithm:
1. Extract $\approx$2000 bottom-up region proposals from input image.
